...
final class PairingController: ObservableObject {
    ...
    private let hostName = "Amfeta-Board"
    ...
    enum PairingError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .localNetworkDenied: return "Local Network permission is off. Enable it in Settings › Amfeta-Board › Local Network."
    ...
    fileprivate func presentPin(_ pin: String) {
        pairingPIN = pin
        pairingStatus = "Enter PIN \(pin) in Settings › Privacy & Security › Developer Mode › Pair with Amfeta-Board"
    }
